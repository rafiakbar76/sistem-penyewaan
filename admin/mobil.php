						...
						<div class="panel panel-default">
							...
							<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php
									$no=0;
									$sqlmobil = "SELECT t1.plat, t1.merk_type, t1.harga, t1.tahun, t2.nama_pt FROM mobil AS t1 INNER JOIN `owner` AS t2 ON t1.id_owner = t2.id_owner";
									...
									?>	
										<tr>
											...
											<td><?php echo htmlentities($result['plat']);?></td>
											...
											<td class="text-center"><a href="mobildel.php?id=<?php echo $result['plat'];?>" onclick="return confirm('Apakah anda akan menghapus <?php echo $result['plat'];?>?');"><i class="fa fa-close"></i></a>
											</td>
										</tr>
										<?php } ?>
									</tbody>
