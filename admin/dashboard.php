...
<head>
	...
	<title>Rental Mobil | Admin Rental</title>
									...
									<div class="col-md-4">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												...
												<?php 
												$sqlbayar = "SELECT id_pemesanan FROM pemesanan ";
												...
												?>
													...
													<div class="stat-panel-title text-uppercase">pemesanan</div>
												</div>
											</div>
											<a href="pemesanan.php" class="block-anchor panel-footer text-center">Rincian &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									...
									<div class="col-md-4">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												<div class="stat-panel text-center">
												<?php 
												$sqlkonfir = "SELECT pembayaran_id FROM pembayaran";
												...
												?>
													...
													<div class="stat-panel-title text-uppercase">Pembayaran</div>
												</div>
											</div>
									...
									<div class="col-md-4">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
												<?php 
												$sqlbelum = "SELECT id_pengembalian FROM pengembalian";
									...
									<div class="col-md-4">
										<div class="panel panel-default">
											<div class="panel-body bk-warning text-light">
												<div class="stat-panel text-center">
												<?php 
												$sql2 = "SELECT id_owner FROM `owner`";
												...
												?>
													...
													<div class="stat-panel-title text-uppercase">car owner</div>
												</div>
											</div>
											<a href="car-owner.php" class="block-anchor panel-footer text-center">Rincian &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="col-md-4">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
												<?php
												$sql = "SELECT id_penyewa FROM penyewa";
