								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									?>	
										<tr align="center">
											...
											<td><?php echo htmlentities($result['pembayaran_id']);?></td>
											<td><?php echo htmlentities($result['pemesanan_id']);?></td>
											<td><?php echo htmlentities($result['tanggal_pembayaran']);?></td>
											<td><?php echo htmlentities($result['jumlah_pembayaran']);?></td>
											<td><?php echo htmlentities($result['metode_pembayaran']);?></td>
										</tr>
										<?php }?>
									</tbody>
								</table>
